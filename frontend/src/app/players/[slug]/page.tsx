...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: `${player.name} - Football Player Profile`,
            ...
            <div className="flex flex-col sm:flex-row items-center gap-5">
              ...
              <div>
                <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2 mb-1.5">
                  ...
                  <span className="text-2xl" title={player.countryName}>{player.country}</span>
                  <FavoriteButton itemType="player" itemId={player.slug} itemName={player.name} size="sm" />
                </div>
                <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2">
                  ...
                  <span className="text-sm text-foreground-muted">Representing {player.countryName}</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="card animate-slide-in-right stagger-2">
              ...
              <p className="text-foreground-secondary leading-relaxed">{player.bio}</p>
            </div>

            {/* Playing Style Card */}
            <div className="card animate-slide-in-right stagger-3">
              <h2 className="text-2xl font-bold mb-4">Tactical &amp; Playing Style</h2>
              <p className="text-foreground-secondary leading-relaxed">{player.style}</p>
            </div>
